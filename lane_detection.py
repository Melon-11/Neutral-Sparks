...
def get_lane_info(image):
    ...
    if contours_blue:
        ...
        if M["m00"] > 0:
            cx_road = int(M["m10"] / M["m00"])  # Road center

    # Find contours for yellow (boundaries)
